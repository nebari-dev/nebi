...
describe('InstallControls', () => {
  it('renders nothing when install status is absent (team mode)', () => {
    const { container } = renderWithProviders(
      <InstallControls projectId="ws-1" installStatus={undefined} />,
    );
  ...
  it('shows a labeled Install button when not installed', () => {
    renderWithProviders(
      <InstallControls projectId="ws-1" installStatus="not_installed" />,
    );
  ...
  it('shows a labeled Retry Install button after a failed install', () => {
    renderWithProviders(
      <InstallControls projectId="ws-1" installStatus="install_failed" />,
    );
    const button = screen.getByRole('button', { name: /install/i });
  ...
  it('shows a labeled Uninstall button when installed', () => {
    renderWithProviders(
      <InstallControls projectId="ws-1" installStatus="installed" />,
    );
  ...
  it('shows a disabled progress indicator while installing', () => {
    renderWithProviders(
      <InstallControls projectId="ws-1" installStatus="installing" />,
    );
