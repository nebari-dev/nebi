...
import { useInstallProject, useUninstallProject } from '@/hooks/useProjects';
...
// Install/Uninstall action for a project's environment. Renders nothing
...
export const InstallControls = ({
  ...
  const installMutation = useInstallProject(projectId);
  const uninstallMutation = useUninstallProject(projectId);
