...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/admin/registries/{id}/grant-group": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Group + action (read|write)",
                        "name": "grant",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.GrantRegistryToGroupRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/registries/{id}/grant-group/{group_id}": {
            "delete": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Group ID to revoke",
                        "name": "group_id",
                        "in": "path",
                        "required": true
                    }
        ...
        "/build-env-vars": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/service.BuildEnvVarResult"
                            }
                        }
                    },
                    "401": {
            ...
            "put": {
                ...
                "parameters": [
                    {
                        "description": "Build environment variable",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.BuildEnvVarRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "handlers.GrantRegistryToGroupRequest": {
            "type": "object",
            "required": [
                "action",
                "group_id"
        ...
        "service.CollaboratorKind": {
            ...
            "x-enum-varnames": [
                "CollaboratorKindUser",
                "CollaboratorKindGroup"
            ]
        },
        "service.CollaboratorResult": {
            ...
            "properties": {
                ...
                "kind": {
                    "$ref": "#/definitions/service.CollaboratorKind"
                },
                "name": {
                    "type": "string"
                },
