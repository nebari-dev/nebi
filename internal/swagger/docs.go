...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/remote/admin/audit-logs": {
            "get": {
                ...
                "responses": {
                    ...
                    "503": {
                        "description": "Not connected to remote server",
                        "schema": {
                            "$ref": "#/definitions/handlers.ErrorResponse"
                        }
                    }
        ...
        "/remote/auto-connect-config": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "remote_url, auto_connect, already_connected",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/remote/connect": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Connection request with url, username, and password",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "status, url, username",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/remote/connect-via-proxy": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Optional request with url (falls back to NEBI_REMOTE_URL env var)",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "type": "object"
                ...
                "responses": {
                    ...
                    "401": {
                        "description": "No IdToken cookie found",
                        "schema": {
                            "$ref": "#/definitions/handlers.ErrorResponse"
                        }
                    },
                    ...
                    "502": {
                        "description": "Remote server unreachable or auth failed",
                        "schema": {
                            "$ref": "#/definitions/handlers.ErrorResponse"
                        }
                    }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cliclient.CreateWorkspaceRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/remote/workspaces/{id}/pixi-toml": {
            "get": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cliclient.PushRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "cliclient.CreateWorkspaceRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
